...
class __Mustache_e7d29b9d19aa8f6e8a5fe6b7df55e418 extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section08230d7005f50cf8814ec47f47988a00($context, $indent, $value);
...
';
    ...
    private function section514ccd909eadc1e96119f8a07d28861e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section08230d7005f50cf8814ec47f47988a00(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('copyrightfooter');
                $buffer .= $this->section514ccd909eadc1e96119f8a07d28861e($context, $indent, $value);
