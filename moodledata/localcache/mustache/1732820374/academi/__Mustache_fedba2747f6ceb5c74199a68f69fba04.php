...
class __Mustache_fedba2747f6ceb5c74199a68f69fba04 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionFa39ba863edb6eba3a05039a3e0f9373($context, $indent, $value);
        $value = $context->find('settingsurl');
        $buffer .= $this->sectionAe9267cb4f37ea329e1cfcdf438279af($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section3d70a16b6ce3a3283dce0f2d624523f9($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
...
';
    ...
    private function sectionFa39ba863edb6eba3a05039a3e0f9373(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '"
';
                $buffer .= $indent . '                        class="btn btn-link p-0 ml-2"
';
                $buffer .= $indent . '                        title="';
                $value = $context->find('str');
...
';
    ...
    private function sectionAe9267cb4f37ea329e1cfcdf438279af(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3d70a16b6ce3a3283dce0f2d624523f9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
