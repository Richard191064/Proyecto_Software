...
/**
 * Strings for component 'cobra', language 'es_mx', version '4.4'.
 *
 * @package     cobra
 * @category    string
...
$string['cobranavigation'] = 'Navegación terciaria para CoBRA';
...
$string['defaultflag2'] = 'Conservar como predeterminado';
$string['defaultflag2_help'] = 'Conservar estas configuraciones como predeterminado para textos futuros';
