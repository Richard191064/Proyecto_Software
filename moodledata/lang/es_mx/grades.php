...
/**
 * Strings for component 'grades', language 'es_mx', version '4.4'.
 *
 * @package     grades
 * @category    string
...
$string['aggregatesonly'] = 'Mostrar solamente totales';
...
$string['aria-toggledropdown'] = 'Alternar el siguiente desplegable';
$string['aria:dropdowngrades'] = 'Elementos de calificación encontrados';
...
$string['calculationwarning'] = 'Esta categoría usa un cálculo de calificación para el total de la categoría en lugar de una agregación.';
...
$string['componentcontrolsvisibility'] = 'El hecho que este elemento de calificación está oculto es controlado por la configuración de la actividad.';
...
$string['deletescale'] = 'Eliminar escala';
...
$string['errorcalculationbroken'] = 'Error en el cálculo del elemento de calificación: {$a})';
...
$string['erroroverweight'] = 'Ponderación total excede 100%';
...
$string['errorunderweight'] = 'Ponderación total es menor de 100%';
...
$string['gradesonly'] = 'Mostrar solamente calificaciones';
...
* Valor - Un valor numérico con un máximo y un mínimo
* Escala - Un elemento en una lista
* Texto - Solo retroalimentación.

Solamente pueden agregarse los tipos de calificación de valor y de escala. El tipo de calificación para un elemento de calificación basado en una actividad se configura en la página de configuración de la actividad.';
$string['gradevaluetoobig'] = 'Uno de los valores de calificación es mayor que la calificación máxima permitida de {$a}';
$string['gradevaluetoosmall'] = 'Uno de los valores de calificación es menor que la calificación mínima permitida de {$a}';
...
$string['missingitemtypeoreid'] = 'Falta la clave del arreglo (itemtype o eid)';
...
$string['moveselectedto'] = 'Mover elementos seleccionados a:';
...
$string['noexistingoutcomes'] = 'No hay resultados existentes.';
$string['noexistingscales'] = 'No hay escalas existentes.';
...
$string['nonunhideableverbose'] = 'Para hacer visible esta calificación, usted necesita hacer visible {$a->itemname}.';
$string['nonunlockableverbose'] = 'Para des-bloquear esta calificación, usted necesita des-bloquear {$a->itemname}.';
...
$string['quickgrading_help'] = 'Si se habilita, cuando se activa la edición, parece una caja para ingresar texto para cada calificación, lo que permite editar varias calificaciones al mismo tiempo. Los cambios son guardados y resaltados cuando se hace clic en el botón para actualizar.
...
$string['showingaggregatesonly'] = 'Mostrando solamente totales';
...
$string['showquickfeedback_help'] = 'Si se habilita, cuando se activa la edición, parece una caja para ingresar texto para cada calificación, lo que permite editar varias calificaciones al mismo tiempo. Los cambios son guardados y resaltados cuando se hace clic en el botón para actualizar.
