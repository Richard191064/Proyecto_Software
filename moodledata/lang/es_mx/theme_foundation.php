...
/**
 * Strings for component 'theme_foundation', language 'es_mx', version '4.4'.
 *
...
$string['addregionblock'] = 'Añadir bloque a región';
...
$string['breadcrumbdisplaymycourses'] = 'Mostrar \'Mis cursos\'';
$string['breadcrumbdisplaymycoursesdesc'] = 'Mostrar \'Mis cursos\' en el camino de migas del menú cuando no está configurado para ser la \'Pagina inicial del sitio\' ya sea por la configuración del núcleo de Moodle  \'defaulthomepage\' (\'Página de inicio para usuarios\') o la preferencia del perfil personal para \'Página de inicio\' cuando  \'defaulthomepage\' está configurada a \'Preferencia del usuario\'.';
$string['breadcrumbheadingdesc'] = 'Configurar las configuraciones para la navegación por \'Migas de pan\' aquí.';
$string['breadcrumbheadingsub'] = 'Migas de pan';
$string['cachedef_foundationfontawesomeiconmapping'] = 'Cachear íconos de Font Awesome';
$string['choosereadme'] = '<div class="clearfix">
<h2>Foundation (Fundación)</h2>
<h3>Acerca de</h3>
<p>Foundation es un tema Bootstrap que pretende ser minimalístico y moderno en apariencia.</p>
<h3>Créditos del tema</h3>
<p>Author: G J Barnard<br>
Contacto: <a href="http://moodle.org/user/profile.php?id=442195" target="_blank">Moodle profile</a><br>
Sitio web: <a href="https://gjbarnard.co.uk" target="_blank">gjbarnard.co.uk</a>
</p>
...
$string['coursesmenuheadingdesc'] = 'Configurar los ajustes para el menú de cursos. No debe confundirese con la página estándar de \'Mis cursos\'.';
...
$string['displayhiddenmycoursesdesc'] = 'Mostrar cursos ocultos para usuarios en el \'Menú de mis cursos\' si ellos tienen permiso para ver cursos ocultos';
$string['displaymycourses'] = 'Mostrar cursos';
$string['displaymycoursesboth'] = 'Ambos';
$string['displaymycoursesdesc'] = 'Mostrar cursos inscritos para usuarios en la \'Barra de Navegación\'. Esto puede estar \'Desactivado\', \'Menú de Mis cursos¡, \'Enlace a página Mis cursos\', o \'Ambos\'.';
$string['displaymycourseslink'] = 'Enlace a página de Mis cursos';
$string['displaymycoursesmenu'] = 'Menú de Mis cursos';
$string['displaymycoursesoff'] = 'Desactivado';
...
$string['faivdesc'] = 'Cuando se use FontAwesome 6 Gratuito para los íconos, añadir soporte para nombres de clase 4 de íconos.';
$string['fav'] = 'FontAwesome 6 Gratuito';
$string['favdesc'] = 'Use la versión de los temas de FontAwesome 6 Gratuito para íconos.  Nota: Por favor vea la licencia en la carpeta fonts del tema.';
...
$string['favoff'] = 'Versión gratuita del núcleo de FontAwesome 6';
$string['featuresheading'] = 'Destacados';
$string['featuresheadingdesc'] = 'Configurar aquí los ajustes para las características.';
...
$string['frontpagecarouselheadingdesc'] = 'Configurar aquí los ajustes para el carrusel de la Portada.';
...
$string['generalheadingdesc'] = 'Configurar las configuraciones generales.';
$string['generalheadingsub'] = 'Configuraciones generales';
$string['generalmenuheadingdesc'] = 'Configurar las configuraciones generales del menú.';
...
$string['headerbackgroundcourseimage'] = 'Imagen del curso del fondo del encabezado';
$string['headerbackgroundcourseimagedesc'] = 'Si los archivos del resumen del curso contienen una o más imágenes, entonces usar la primera como una imagen del fondo del encabezado.';
...
$string['headerheadingdesc'] = 'Configurar aquí los ajustes del encabezado.';
...
$string['hvpheadingdesc'] = 'Configurar las configuraciones . Estas configuraciones solamente tendrán efecto si el módulo H5P  (moodle.org/plugins/mod_hvp) está instalado.';
...
$string['navbareditswitch'] = 'Switch para editar';
$string['navbareditswitchdesc'] = 'Tener  el switch para editar en la Barra de Navegación.';
...
$string['propertiesdesc'] = 'En esta sección Usted puede importar / exportar configuraciones actuales del tema  (propiedades) en formato JSON. Usted también puede ver todas las configuraciones actuales en esta instalación Moodle.';
...
$string['swatchcustomcoloursheadingdesc'] = 'Configurar las configuraciones personalizadas de color de swatch.';
...
$string['swatchcustomtypographyheadingdesc'] = 'Configurar las configuraciones tipográficas personalizadas de swatch.';
...
$string['swatchheadingdesc'] = 'Configurar las configuraciones de swatch.';
...
$string['syntaxhighlightremoveddesc'] = 'La funcionalidad del resaltado de sintaxis ha sido quitada.  Por favor use el filtro \'<a href="https://moodle.org/plugins/filter_synhi" target="_blank">SynHi</a>\' como un sustituto.';
$string['themechanges'] = 'Cambios';
$string['themereadme'] = 'Léame';
$string['themesupport'] = 'Soporte';
$string['thiscourse'] = 'Este curso';
$string['thiscoursemenuheadingdesc'] = 'Configurar las configuraciones para el menú \'Este curso\'.';
...
$string['unaddableblocksdesc'] = 'Los bloques especificados no serán enlistados en el menú de \'Añadir un bloque\'.  Esta es una lista separada por comas sin espacios del nombre de la \'carpeta\' del bloque dentro de la carpeta \'blocks\'. Si usted quiere ocultar completamente un bloque, como por ejemplo el Bloque de Navegación, entonces vaya a \'Administración del sitio\' -> Plugins -> Bloques -> \'Gestionar bloques\'.';
